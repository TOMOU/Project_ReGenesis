...
//    {
//        if (className != "LocalizationTable")
//        {
//            return;
//        }
...
//    {
//        var type = reader.GetRow(0);
//        var name = reader.GetRow(1);
...
//            sb.Append($"{type.GetValue<string>(i)} {name.GetValue<string>(i).FirstCharacterToLower()}");
//        }
//        sb.AppendLine(")");
//        sb.AppendLine("\t{");
//        for (int i = 0; i < reader.colCount; i++)
//        {
//            sb.AppendLine($"\t\t{name.GetValue<string>(i)} = {name.GetValue<string>(i).FirstCharacterToLower()};");
//        }
//        sb.AppendLine("\t}");
//        sb.AppendLine("}");
//        sb.AppendLine();
...
//        sb.AppendLine("\t{");
//        sb.AppendLine("\t\tstring name = GetType().Name;");
//        sb.AppendLine("\t\tCSVReader reader = CSVReader.Load(name);");
//        sb.AppendLine("\t\tif (reader == null)");
//        sb.AppendLine("\t\t{");
//        sb.AppendLine("\t\t\tLogger.LogErrorFormat(\"Failed to load {0}.\", name);");
//        sb.AppendLine("\t\t\treturn;");
//        sb.AppendLine("\t\t}");
//        sb.AppendLine();
//        sb.AppendLine($"\t\t_table = new List<{dataName}>();");
//        sb.AppendLine();
//        sb.AppendLine("\t\tfor (int i = 1; i < reader.rowCount; i++)");
//        sb.AppendLine("\t\t{");
...
//            string n = name.GetValue<string>(i).FirstCharacterToLower();
